<template>
  <article class="presentational-product" refs="head" @click="log">
...
<script>
  ...
  import image_0 from '../../assets/advantage_0.png';
        ...
        advantageList: [
          {
            id: 1,
            img: image_0,
            text: 'Защищённый изогнутым стеклом 2К-дисплей с диагональю 8,4 или 10,8 дюйма  поражает детализацией картинки. Технология ClariVu 5.0 расширяет динамический диапазон, увеличивая контрастность и насыщенность, а режим Eye Comfort снижает усталость глаз при использовании планшета вечером и ночью.'
          },
          {
            id: 2,
            img: image_0,
            text: 'Восьмиядерный процессор Kirin 960 в связке с 4 ГБ оперативной памяти обеспечивает безупречную производительность как для рабочих задач, так и в играх. А внутренняя память объёмом 32 или 64 ГБ вмещает все необходимые документы, файлы и медиаконтент.'
          },
          {
            id: 3,
            img: image_0,
